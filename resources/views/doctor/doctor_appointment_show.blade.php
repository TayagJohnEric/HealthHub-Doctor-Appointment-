        ...
        <div class="profile-card">        
            ...
            <div class="profile-content">      
                ...
                <div class="profile-info">
                    ...
                    <p><strong>Patient Name:</strong> {{ $appointment->patient->birth_date }}</p>
                    <p><strong>Patient Name:</strong> {{ $appointment->patient->contact_info }}</p>
                    <p><strong>Birth Date:</strong> {{ $appointment->patient->gender}}</p>
                    <p><strong>Birth Date:</strong> {{ $appointment->patient->email}}</p>
                    <p><strong>Contact Information:</strong> {{ $appointment->patient->contact_info}}</p>
                    <p><strong>Gender:</strong> {{ $appointment->schedule->schedule_time}}</p>
                    <p><strong>Date Scheduled:</strong> {{ $appointment->created_at}}</p>                   
                </div>
            </div>
        </div>
    </div>
