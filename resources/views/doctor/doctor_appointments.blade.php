...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/doctor/doctor_appointments.css') }}">
...
.buttons-container {
    ...
    margin-top: 10px; /* Space between buttons and select */
}



/* Style for each button inside the buttons container */
...
.select-status {
    width: 40%; /* Full width to fill the table cell */
    padding: 5px;
    font-size: 12px;
    margin-top: 5px; /* Space between buttons and select */
}
...
.delete-btn{
    ...
    background: rgba(185, 44, 44, 0.955);
}
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="buttons-container">
                                    <div class="btns">
                                        <a href="{{route('doctor.myAppointments.show', $appointment->id)}}">
                                     ...
                                     <form method="POST" action="{{ route('appointment.updateStatus', $appointment->id) }}">
                                        @csrf
                                        @method('PUT')
