...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/patient/patient_doctor.css') }}">
  <style>
    body {
    margin: 0;
...
.scheduled-sessions-title {
    ...
    margin-left: 30px; /* Add margin from the left edge */
}

/* Make sure the table-top container doesn't force centering */
.table-top {
    display: flex;
...
<body>
  ...
  <div class="content">
    <div class="table-top">
        <h1 class="scheduled-sessions-title">All Doctors</h1>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="buttons-container">        
                            <a href="{{route('patient.doctor.show', $doctor->id)}}" method="get">
