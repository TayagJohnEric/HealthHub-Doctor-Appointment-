...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/patient/patient_scheduled_session.css') }}">
  <style>
    body {
    margin: 0;
...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="{{ route("patient.appointmentHistory")}}" method="get"> <i class="fas fa-history"></i> Appointment History   </a>
  ...
  <div class="content">
    <div class="table-top">
        <h1 class="scheduled-sessions-title">Scheduled Sessions</h1>
    </div>
                ...
                @foreach($doctors as $doctor)
                    @foreach($doctor->schedules as $schedule)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('patient.bookAppointment') }}" method="POST">
                                    @csrf
