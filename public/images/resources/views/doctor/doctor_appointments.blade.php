                            ...
                            <td>
                                <div class="buttons-container">
                                    <a href="{{route('doctor.myAppointments.show', $appointment->id)}}">
                                     ...
                                     <form action="{{ route('doctor.myAppointment.destroy', $appointment->id) }}" method="POST" style="display:inline;"> 
                                        @csrf
                                         @method('DELETE') 
                                         <button type="submit" class="cancel-session-button">Cancel Session</button> 
                                        </form>
                                </div>
                            </td>
                        </tr>
