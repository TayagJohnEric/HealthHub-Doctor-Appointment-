...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/doctor/doctor_schedule_index.css') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="buttons-container">
                                    <a href="{{route('doctor.mySchedule.show', $schedule->id)}}">
                                        <button type="submit">View</button>
                                     </a>                         
                                     
                                     <form action="{{ route('doctor.mySchedule.destroy', $schedule->id) }}" method="POST" style="display:inline;"> 
                                        @csrf
                                         @method('DELETE') 
                                         <button type="submit" class="cancel-session-button" >Cancel Your Session</button> 
                                        </form>
                            </td>
                        </tr>
                    @endforeach
