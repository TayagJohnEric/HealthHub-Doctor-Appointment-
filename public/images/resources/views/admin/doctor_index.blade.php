...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/doctor_index.css') }}">
...
<body>
    ...
    <div class="content">
        ...
        <div class="table-top">
            <form action="{{ route('admin.create.doctor')}}" method="get">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="buttons-container">
                                <a href="{{route('admin.doctor.edit', $doctor->id)}}" method="get">
                                    <button type="submit">Edit</button>
                                 </a>
                                
                                <a href="{{route('admin.doctor.show', $doctor->id)}}" method="get">
